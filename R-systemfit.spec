...
Version  : 1.1.26
Release  : 45
URL      : https://cran.r-project.org/src/contrib/systemfit_1.1-26.tar.gz
Source0  : https://cran.r-project.org/src/contrib/systemfit_1.1-26.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655823441
